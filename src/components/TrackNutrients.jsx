...
function TrackNutrients(props) {
      ...
      axios.get(url,config).then((res)=> {
          ...
          setSugar(res.data.item[0].sugar_g)
          setCarbohydrates(res.data.item[0].carbohydrates_total_g)
          setProtien(res.data.item[0].protein_g)
          setCholestrol(res.data.item[0].cholesterol_mg)
          SetCalories(res.data.item[0].calories)
          SetTotalFat(res.data.item[0].fat_total_g)
          SetSFat(res.data.item[0].fat_saturated_g)
          // setPo(res.data.item[0].potassium_mg)
          setSodium(res.data.item[0].sodium_mg)
          setFibre(res.data.item[0].fiber_g)
          setServing(res.data.item[0].serving_size_g)
